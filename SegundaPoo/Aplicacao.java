...
public class Aplicacao {
    ...
    public static void main(String[] args) {
        ...
        int n = 1;
        do {
            System.out.println("Digite uma opção para começar as operações,digite 0 para sair.");
            ...
            if (n == 1) {
                ...
                System.out.println("Número de conta cadastrado com o número " + listaContas.size());
            }
            if (n == 2) {
        ...
        private static Cliente cadastrarCliente () {
                Scanner teclado = new Scanner(System.in);
                System.out.println("Processo para abertura de conta inicializada");
